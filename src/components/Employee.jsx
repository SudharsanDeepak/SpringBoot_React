...
const Employee = () => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        const response = await axios.get("https://springbootproject-q5gi.onrender.com/employee", {
          headers: {
  ...
  const handleDelete = async (empId) => {
    try {
      await axios.delete(`https://springbootproject-q5gi.onrender.com/employee/${empId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleEditSubmit = async () => {
    try {
      await axios.put(`https://springbootproject-q5gi.onrender.com/employee/${editEmployee.empId}`, editEmployee, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
